    ...
    (function (skanaar) {
        ...
        function Svg(globalStyle, canvas) {
            ...
            return {
                ...
                rect: function (x, y, w, h, id, cls) {
                    return newElement('rect', { x: tX(x), y: tY(y), height: h, width: w, id: id, class: cls });
                },
                path: tracePath,
                circuit: function (path, offset, s) {
...
(function (nomnoml) {
    ...
    nomnoml.visualizers = {
        ...
        "class": function (node, x, y, config, g) {
            g.rect(x, y, node.width, node.height, node.name, "node").fillAndStroke();
        },
